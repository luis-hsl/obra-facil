...
const cards: {
  ...
  { key: 'numProjetos', label: 'Projetos', icon: IconProjetos, format: (v) => String(v), colorClass: 'text-slate-700', iconBg: 'bg-slate-50 text-slate-500', borderClass: 'border-slate-100' },
];
