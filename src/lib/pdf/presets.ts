...
export const PRESET_CLASSIC: PdfPreset = {
  ...
  budgetTable: {
    ...
    columns: [
      ...
      { key: 'unit_price', label: 'Valor/m²', widthPercent: 15, align: 'right' },
      { key: 'total', label: 'Total', widthPercent: 15, align: 'right' },
      { key: 'discount_price', label: 'À Vista', widthPercent: 18, align: 'right' },
    ],
    showHeader: true,
    showBorders: true,
